...
% Al trabajar con un documento, el tamaño de hoja, de letra, la cantidad de columnas, el formato, la disposición de la hoja, etc. En el código de \documentclass[opciones]{clase} es posible definir ciertas opciones para:
%	-Tamaño de fuente:
%	  -10pt
%	  -11pt
%	  -12pt
...
% Dentro del propio comando de \documentclass{} se provee entre corchetes [], previo a definir la clase, las opciones que se quiere tener en el documento separadas por comas.
